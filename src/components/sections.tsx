      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: "rgba(200, 216, 240, 0.65)" }}>Купол Планетария 1 превратится в магическое пространство, где виолончель и фортепиано перенесут вас в миры Тоторо, Хаула и Сан — прямо среди звёзд.</p>
            <p className="text-sm leading-relaxed mb-2 italic" style={{ color: "var(--star-gold)", opacity: 0.85 }}>Хаяо Миядзаки</p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            {
              name: "Михаил Зайденберг",
              role: "Фортепиано",
              bio: "Пианист, композитор, саунд-продюсер, лауреат международных конкурсов, стипендиант гранта Президента РФ.",
              bio2: "Его сила — невероятное умение смешивать стили и жанры в своих импровизациях. Джаз и классика, поп и авангард — всё соединяется в единую музыкальную фантазию.",
              photo: "https://cdn.poehali.dev/projects/bc5b0359-d47d-4d80-b141-57f2c7c367aa/bucket/46e93adf-a7e9-4716-957a-f47cb56cbb03.JPG",
